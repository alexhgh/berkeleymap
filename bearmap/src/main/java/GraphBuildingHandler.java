...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private ArrayList<Long> pendingNode;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            activeState = "way";
            prevWayID = Long.parseLong(attributes.getValue("id"));
            pendingNode = new ArrayList<>();

        } else if (activeState.equals("way") && qName.equals("nd")) {
            /* While looking at a way, we found a <nd...> tag. */
            pendingNode.add(Long.parseLong(attributes.getValue("ref")));
            ...
            if (k.equals("maxspeed")) {
                ...
                maxSpeed = Long.parseLong(v.replaceAll(" mph", ""));
            ...
            /** Create a location. */
            nameofNode = attributes.getValue("v");
        }
    }
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            if (valid) {
                g.addWay(pendingNode, prevWayID);
            } else {
                pendingNode = new ArrayList<>();
            }
            valid = false;
            ...
            g.locationlist.insert(g.cleanString(nameofNode), id, prevlon, prevlat, nameofNode);
            }
            nameofNode = "";
        }
    }
