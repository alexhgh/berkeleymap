...
public class MapServer {
    ...
    public static List<String> getLocationsByPrefix(String prefix) {
        String qurey = graph.cleanString(prefix);
        return graph.locationlist.startsWith(qurey);
    }
    ...
    public static List<Map<String, Object>> getLocations(String locationName) {
        String qurey = graph.cleanString(locationName);
        List<Map<String, Object>> solution = new ArrayList<>();
        List<Location> result = graph.locationlist.searchNode(qurey);
        for (Location l : result) {
            solution.add(l.getMap());
        }
        return solution;
    }
